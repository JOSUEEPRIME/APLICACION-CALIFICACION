        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm" onClick={onClose}>
            ...
            >
                ...
                <div className="w-1/2 flex flex-col h-full bg-white">
                            ...
                            <div className="flex-1 mr-4">
                                ...
                                {isEditing ? (
                                    <input
                                        ...
                                        className="w-full font-bold text-gray-900 border-b border-gray-300 focus:border-primary outline-none pb-1"
                                    />
                                ) : (
                                    ...
                                    <div className="flex items-end justify-end gap-1">
                                        {isEditing ? (
                                            <input
                                                ...
                                                className="w-16 text-3xl font-bold text-primary text-right border-b border-gray-300 focus:border-primary outline-none"
                                            />
                                        ) : (
                                            <span className="text-3xl font-bold text-primary">{submission.result.score}</span>
                                        )}
                    ...
                    <div className="p-4 border-t border-gray-200 bg-light flex justify-end">
                        <button
                            onClick={onClose}
